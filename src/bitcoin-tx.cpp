...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dankcoin Core dankcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dankcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dankcoin transaction") + "\n" +
              "  dankcoin-tx [options] -create [commands]   " + _("Create hex-encoded dankcoin transaction") + "\n" +
              "\n";
