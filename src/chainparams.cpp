...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("dankcointools.com", "dnsseed.dankcointools.com"));
        vSeeds.push_back(CDNSSeedData("dankcoinpool.org", "dnsseed.dankcoinpool.org"));
        vSeeds.push_back(CDNSSeedData("xurious.com", "dnsseed.pepe.xurious.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("dankcointools.com", "testnet-seed.dankcointools.com"));
        vSeeds.push_back(CDNSSeedData("xurious.com", "testnet-seed.pepe.xurious.com"));
